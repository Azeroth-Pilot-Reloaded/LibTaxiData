...
lib.ClientProfiles = {
    { profile = "retail", dataSet = "retail", version = "retail", gameType = "mainline", channel = "live", build = "12.0.7.68887", interface = 120007, product = "wow", default = true },
    { profile = "retail_ptr", dataSet = "retail_ptr", version = "retail", gameType = "mainline", channel = "ptr", build = "12.1.0.68914", interface = 120100, product = "wowt" },
    { profile = "mists", dataSet = "mists", version = "mists", gameType = "mists", channel = "live", build = "5.5.4.68806", interface = 50504, product = "wow_classic", default = true },
    ...
    { profile = "classic", dataSet = "classic", version = "classic", gameType = "classic", channel = "live", build = "1.15.9.68940", interface = 11509, product = "wow_classic_era", default = true },

...
lib.ClientProfiles = {
    { profile = "retail", dataSet = "retail", version = "retail", gameType = "mainline", channel = "live", build = "12.1.0.69587", interface = 120100, product = "wow", default = true },
    ...
    { profile = "classic", dataSet = "classic", version = "classic", gameType = "classic", channel = "live", build = "1.15.9.69547", interface = 11509, product = "wow_classic_era", default = true },
